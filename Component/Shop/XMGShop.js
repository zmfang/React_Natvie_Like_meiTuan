...
class XMGShop extends React.Component
{
    ...
    renderNavBar()
    {
        return(
            <View style={styles.navBarStyle}>
                ...
                >
                    <Image source={{uri:'icon_shop_local'}} style={styles.navRightImgStyle}/>
                </TouchableOpacity>
                ...
                >
                    ...
                    <Image source={{uri:'icon_shop_search'}} style={styles.navRightImgStyle}/>
                </TouchableOpacity>
            </View>
        )
    }
